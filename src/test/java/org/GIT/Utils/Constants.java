...
public class Constants {
	 public final static String PROJECT_HOME = System.getProperty("user.dir");
	    ...
	    public final static String ENVIRONMENT_DETAILS_PROPERTIES_FILE = TEST_RESOURCES + File.separator + "EnvironmentDetails" + File.separator + "GIT.properties";
